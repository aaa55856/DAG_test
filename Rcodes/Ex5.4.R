...
## p_1 = p_2 = p_3 = p
## n=50, d=3, p=5, Mp=500, reptim=1000

set.seed(1)
Ex3ii = Sim.size.list(n=50, d=3, p=5, cc=1, index=1, type=3, Mp=500, reptim=1000, Ustat=TRUE)

set.seed(2)
Ex4.i = Sim.size.list(n=50, d=3, p=5, cc=1, index=1, type=4, Mp=500, reptim=1000, Ustat=TRUE)


## n=50, d=3, p=10, Mp=500, reptim=1000

set.seed(4)
Ex3ii_10 = Sim.size.list(n=50, d=3, p=10, cc=1, index=1, type=3, Mp=500, reptim=1000, Ustat=TRUE)

set.seed(5)
Ex4.i_10 = Sim.size.list(n=50, d=3, p=10, cc=1, index=1, type=4, Mp=500, reptim=1000, Ustat=TRUE)
